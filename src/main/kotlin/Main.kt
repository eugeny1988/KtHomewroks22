...
val post1 = Post(0, 1, 2, 3, 1234, "Hello World!", 123, 245, false, comments1, copyright1, likes1,reposts1,1000,"post",24,true,true,false,false,false,true,donut1,11)
...
val post2 = Post(0, 1, 2, 3, 1234, "Hello World!", 123, 245, false, comments2, copyright2, likes2,reposts2,1000,"post",24,true,true,false,false,false,true,donut2,11)
...
val post3 = Post(0, 1, 2, 3, 1234, "Hello World!", 123, 245, false, comments2, copyright2, likes2,reposts2,1000,"post",24,true,true,false,false,false,true,donut2,11)
var postArray: Array<Post> = arrayOf()
val wallService = WallService(post1, post2, post3, postArray)
fun main() {
//print("$wallService")
}